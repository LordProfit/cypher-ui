...
```bash
git clone https://github.com/cypher-ui-ui/ui.git
```
...
This follows the registry schema at [https://ui.cypher-ui.com/schema/registry-item.json](https://ui.cypher-ui.com/schema/registry-item.json).
...
export const blocks = [
  ...
  {
    name: "dashboard-01",
    author: "cypher-ui (https://ui.cypher-ui.com)",
    title: "Dashboard",
