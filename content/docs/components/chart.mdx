...
**Note:** We're working on upgrading to Recharts v3. In the meantime, if you'd like to start testing v3, see the code in the comment [here](https://github.com/cypher-ui-ui/ui/issues/7669#issuecomment-2998299159). We'll have an official release soon.
...
```bash
npx cypher-ui@latest add chart
```
