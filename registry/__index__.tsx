...
export const Index: Record<string, any> = {
  ...
  "glass-card": {
    name: "glass-card",
    description: "A glass-style card component with iOS 26 vibes.",
    type: "registry:ui",
    registryDependencies: undefined,
    files: [{
      path: "registry/new-york-v4/ui/glass-card.tsx",
      type: "registry:ui",
      target: ""
    }],
    component: React.lazy(async () => {
      const mod = await import("@/registry/new-york-v4/ui/glass-card.tsx");
      const exportName = Object.keys(mod).find(key => typeof mod[key] === 'function' || typeof mod[key] === 'object') || "glass-card";
      return { default: mod.default || mod[exportName] };
    }),
    categories: ["card","glass","ios"],
    meta: {"style":"ios-glass"}
  },
  "carousel": {
    name: "carousel",
    description: "",
